...
final class ProxyRoutingTests: XCTestCase {
    ...
    func testLANPrefixIsTheFirstThreeOctets() {
        XCTAssertEqual(lanPrefix(of: "192.168.50.117"), "192.168.50")
    ...
    func testLANPrefixRejectsAnythingThatIsNotADottedQuad() {
        ...
        XCTAssertNil(lanPrefix(of: "192.168.50"), "three octets is not an address")
        XCTAssertNil(lanPrefix(of: "192.168.50.117.5"), "five octets is not an address")
        XCTAssertNil(lanPrefix(of: "192.168.50.999"), "999 is not an octet")
        XCTAssertNil(lanPrefix(of: "192.168.50."), "empty last octet")
    ...
    func testTXTRecordNeverCarriesAPassword() {
        let ad = ProxyAdvertisement(serviceName: "personal-mac", port: 9999, authRequired: true,
                                    host: "192.168.1.42", exitIP: "198.51.100.7")
        ...
        XCTAssertEqual(txt["vpnip"], "198.51.100.7")
    ...
    func testTXTRoundTripsThroughParsing() {
        ...
        XCTAssertEqual(parsed, DiscoveredProxy(name: "personal-mac", host: "192.168.1.42", port: 9999,
                                               authRequired: true, exitIP: "198.51.100.7",
