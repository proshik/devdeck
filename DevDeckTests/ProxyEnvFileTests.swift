...
final class ProxyEnvFileTests: XCTestCase {
    ...
    func testTheWrittenFileIsOwnerOnly() throws {
        ...
        XCTAssertTrue(LiveProxyEnvFile(url: url).write("DEVDECK_PROXY_URL=http://dev:s3cret@192.168.50.117:9999\n"))

        XCTAssertEqual(try mode(of: url), 0o600)
        XCTAssertEqual(try String(contentsOf: url, encoding: .utf8),
                       "DEVDECK_PROXY_URL=http://dev:s3cret@192.168.50.117:9999\n")
    }
